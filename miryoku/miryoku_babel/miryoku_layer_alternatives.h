...
U_NA,              &kp RA(P),         &kp RA(Q),         U_NA,              U_NA,              U_NA,              &u_to_U_NAV,       &u_to_U_NUM,       &kp RALT,          U_NA,              \
...
U_WH_D,            U_MS_L,            U_MS_D,            U_MS_R,            &kp CAPS,          U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
U_UND,             U_CUT,             U_RDO,             U_CPY,             U_PST,             U_NA,              &u_to_U_MOUSE,     &u_to_U_SYM,       &kp RALT,          U_NA,              \
...
U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            &kp CAPS,          U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
...
&kp LG(F12),       &kp K_BACK,        &kp C_VOL_UP,      &kp K_FORWARD,     &kp LG(F10),       U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
...
&kp K_BACK,        &kp LG(F11),       &kp LG(F12),       &kp K_FORWARD,     &kp LG(F10),       U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
